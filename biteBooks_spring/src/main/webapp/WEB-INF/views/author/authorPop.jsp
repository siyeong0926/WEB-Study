...
<link rel="stylesheet" href="../resources/css/author/authorPop.css">
	...
	<div class="content_wrap">
		...
		<div class="author_table_wrap">
			...
			<div class="search_wrap">
				<form id="searchForm" action="/author/authorPop" method="get">
			...
			<form id="moveForm" action="/author/authorPop" method="get">
