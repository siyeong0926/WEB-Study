...
<link rel="stylesheet" href="../resources/css/book/goodsModify.css">
...
<body>
                ...
                <div class="admin_content_wrap">
                    ...
                    <div class="admin_content_main">
                    	<form action="/book/goodsModify" method="post" id="modifyForm">
                	...
                	<form id="moveForm" action="/book/goodsManage" method="get" >
	...
	$("#deleteBtn").on("click", function(e){
		...
		moveForm.attr("action", "/book/goodsDelete");
